        ...
        <form className={classes.form} noValidate onSubmit={formsubmithandler}>
          <Grid container spacing={2}>
            ...
            <Grid item xs={12} sm={4}>
              <TextField variant="outlined" required fullWidth id="standard name" label="Standard Name" name="standard name" autoComplete="standard name"/>
            </Grid>
            ...
            <Grid item xs={12} sm={12}>
            <TextField variant="outlined" required fullWidth id="published date " label="Publihed Date" name="published date " autoComplete="published date "/>
            </Grid>
